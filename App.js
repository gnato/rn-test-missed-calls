...
const CallLog = async data => {
  ...
  var number = data.phone_number;
  var url = `https://sample-domain.com/endpoint/who/${who}/number/${number}`;
  ...
  axios
    ...
    .then(function(response) {
      ...
      var opts = {
        ...
        bigText: "Some totification", // (optional) default: "message" prop
  ...
  render() {
    return (
      <View style={styles.container}>
        <Text style={styles.welcome}>Test app</Text>
        <TextInput
          style={styles.ipt}
